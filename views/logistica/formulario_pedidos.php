...
<select id="moto" name="pedido[moto]">
    ...
    <option <?php echo 'Mototaxi' == $pedido->motor ? 'selected' : ''; ?> value="Mototaxi">Mototaxi</option>
    <option <?php echo 'Motocarga' == $pedido->motor ? 'selected' : ''; ?> value="Motocarga">Motocarga</option>
    <option <?php echo 'Carguero' == $pedido->motor ? 'selected' : ''; ?> value="Carguero">Carguero</option>
</select>
...
<select id="tipo" name="pedido[tipo]">
    ...
    <option <?php echo 'Redorzada' == $pedido->tipo ? 'selected' : ''; ?> value="Redorzada">Redorzada</option>
...
<select id="color" name="pedido[color]">
    <option value="" disabled>-- Seleccione --</option>
    <option <?php echo 'Azul' == $pedido->motor ? 'selected' : ''; ?> value="Azul">Azul</option>
    <option <?php echo 'Negro' == $pedido->motor ? 'selected' : ''; ?> value="Negro">Negro</option>
    <option <?php echo 'Rojo' == $pedido->motor ? 'selected' : ''; ?> value="Rojo">Rojo</option>
    <option <?php echo 'Naranja' == $pedido->motor ? 'selected' : ''; ?> value="Naranja">Naranja</option>
</select>
...
<select id="aro" name="pedido[aro]">
    <option value="" disabled>-- Seleccione --</option>
    <option <?php echo 'Estrella' == $pedido->aro ? 'selected' : ''; ?> value="Estrella">Estrella</option>
    <option <?php echo 'Deportivo' == $pedido->aro ? 'selected' : ''; ?> value="Deportivo">Deportivo</option>
...
<select id="mica" name="pedido[mica]">
    <option value="" disabled>-- Seleccione --</option>
    <option <?php echo 'Aero' == $pedido->mica ? 'selected' : ''; ?> value="Transparente">Transparente</option>
