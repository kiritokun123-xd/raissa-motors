<main class="main">
    <h2 class="main-titulo">Inventario - Actualizar Stock</h2>
    <?php
    ...
    <div class="popup-newarticulo" id="popup-newarticulo">
        <div class="contenido-newarticulo">
            <div class="newarticulo-head">
                ...
                <a href="/ensamblaje/inventario" class="btn-cerrar" id="btn-cerrar">
            ...
            <div class="newarticulo-info">
                <form class="formulario" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="btns-form">
                        ...
                        <a href="/ensamblaje/inventario" class="btn-cancelar" id="btn-cancelar">Atras</a>
                    </div>
                </form>
            </div>
        </div>
