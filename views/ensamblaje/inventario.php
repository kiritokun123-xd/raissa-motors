<main class="main">
    <h2 class="main-titulo">Inventario Ensamblaje</h2>
                ...
                <tr>
                    ...
                    <td class="td-acciones"> 
                        <div class="div-acciones td-stock">
                            <a href="/ensamblaje/actualizar-stock?id=<?php echo $articulo->id; ?>" class="accion-actualizar"><i class="bx bxs-pencil"></i></a>
                        </div>
                    </td>
                </tr>
                <?php endforeach; ?>
    ...
    <div class="gestion-articulo">
        ...
        <?php for($i = 1 ;$i<=$totalLink; $i++) : ?>
            <a href="/ensamblaje/inventario?pag=<?php echo $i ?>" class="paginas"><?php echo $i ?></a>
        <?php endfor; ?>
        </div>
    </div>
